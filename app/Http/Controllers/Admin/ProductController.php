...
class ProductController extends Controller
{
    ...
    public function image()
    {
        ...
        return view('admin.product.product_image',compact('datas'));
    }
    public function image_delete($id)
    {
        $data = ProductDetails::find($id);

        if (file_exists( public_path().'/uploads/product/product_details/'.$data->product_multiple_photo_name)) {
            $location = public_path().'/uploads/product/product_details/'.$data->product_multiple_photo_name;
            unlink($location);
            $data->delete();
        }
        else
