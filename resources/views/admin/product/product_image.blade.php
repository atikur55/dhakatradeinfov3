    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <h6 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Product Image List</h6>
                <!--end::Actions-->
            </div>
            <!--end::Info-->
        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="{{route('admin.product.product_image_delete', ['id' => $data->id])}}" class="btn btn-danger">Delete</a>
...
<div class="modal fade" id="editModal{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body m-auto">
                <form action="{{ route('admin.product.product_image_update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
