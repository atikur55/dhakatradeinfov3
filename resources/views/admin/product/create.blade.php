                    ...
                    <div class="card card-custom">
                        ...
                        <div class="card-body">
                            <div id="overlay" style="display:none">
                                <div id="text">Wait few second</div>
                            </div>
                            ...
                            <form id="AddProductForm" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                      ...
                                      <input type="number" class="form-control" id="price_taka" name="price" onchange="myFunctiontaka(this.value)"  placeholder="85196.93"/>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control" id="price_dollar" name="price_dollar" onchange="myFunction(this.value)" placeholder="1000" readonly/>
                                ...
                                <div class="form-group row">
                                  <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-4">
                                      ...
                                      <input type="number" name="product_quantity" placeholder="E.g: 200" class="form-control"/>
                                  ...
                                  <div class="col-lg-4">
                                      ...
                                      <input type="number" name="min_order_quantity" placeholder="E.g: 2" class="form-control"/>
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                      <label>Price in Taka(&#2547;)</label>
                                      <input type="number" name="product_price_one" id="product_price_one" onchange="priceonetaka(this.value)" class="form-control" value="" placeholder="E.g: 1000/(piece)"/>
                                    ...
                                    <div class="col-lg-4">
                                      <label>Price in Dollar($)</label>
                                      <input type="text" name="product_price_one_dollar" onchange="priceonedollar(this.value)" id="product_price_one_dollar" value="" class="form-control" placeholder="E.g: $430/(piece)" readonly/>
                                 ...
                                 <div class="form-group row">
                                  ...
                                  <div class="col-lg-4">
                                    <label>Price in Taka(&#2547;)</label>
                                    <input type="number" name="product_price_two" id="product_price_two" onchange="pricetwotaka(this.value)" class="form-control" value="" placeholder="E.g: 410/(piece)"/>
                                  ...
                                  <div class="col-lg-4">
                                    <label>Price in Dollar($)</label>
                                    <input type="text" name="product_price_two_dollar" id="product_price_two_dollar" onchange="pricetwodollar(this.value)"  class="form-control" value="" placeholder="E.g: $420/(piece)" readonly/>
                               ...
                               <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                  <label>Price in Taka(&#2547;)</label>
                                  <input type="number" name="product_price_three" id="product_price_three" onchange="pricethreetaka(this.value)" class="form-control" value="" placeholder="E.g: 480/(piece)"/>
                                ...
                                <div class="col-lg-4">
                                  <label>Price in Dollar($)</label>
                                  <input type="text" name="product_price_three_dollar" id="product_price_three_dollar" onchange="pricethreedollar(this.value)" value="" class="form-control" placeholder="E.g: $400/" readonly/>
