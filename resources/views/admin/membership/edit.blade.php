    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <h6 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Edit Membership Packages</h6>
                <!--end::Actions-->
            </div>
            <!--end::Info-->
        </div>
                    ...
                    <div class="card card-custom">
                        <div class="card-header">
                            <div class="card-title">
                                <h3 class="card-label">Edit Membership Packages</h3>
                            </div>
                            ...
                            <form action="{{route('admin.membership.store')}}" method="POST" enctype="multipart/form-data" class="form">
                                @csrf
                                    <div class="form-group">
                                        ...
                                        <input autocomplete="off" type="text" class="form-control form-control-solid" name="membership_name" placeholder="Enter Full Category Name" value="{{ $membership->name }}"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input autocomplete="off" type="number" class="form-control form-control-solid" name="membership_price" placeholder="Enter Membership Price" value="{{ $membership->price }}"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="membershipdetails">
                                            @foreach ($membership->details as $detail)
                                                <div class="d-flex">
                                                    <input value="{{ $detail->details }}" autocomplete="off" type="text" class="form-control form-control-solid mb-2" name="membership_details[]" placeholder="Enter Membership details"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="membershipProductDetails">
                                            ...
                                            <div>
                                                <input value="{{ $product->ammount }}" autocomplete="off" type="text" class="form-control form-control-solid mb-2 mr-2" name="membership_product_ammountofuploads[]" placeholder="Enter Ammount of Product Uploads"/>
                                                <input value="{{ $product->price }}" autocomplete="off" type="number" class="form-control form-control-solid mb-2 ml-2" name="membership_product_price[]" placeholder="Enter Price"/>
                                                <i class="fas fa-trash" onclick="$(this).parent().remove()"></i>
                                            </div>
                                            @endforeach
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="" class="form-control">
                                            ...
                                            <option value="0" @if($membership->status === 0) selected @endif >Active</option>
                                            <option value="1"  @if($membership->status === 1) selected @endif >Inactive</option>
                                        </select>
