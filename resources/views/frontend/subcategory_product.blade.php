                            ...
                            <div class="category-sidebar-item">
                                <ul>
                                    @foreach ($othersubcategories as $subcategory)
                                        <li class="{{$subcategoryID->id == $subcategory->id ? 'activeSubcategory': ''}}">
                                            <a href="{{url('subcategory_product')}}/{{$subcategory->id}}"><i class="fas fa-angle-double-right"></i> {{ $subcategory->title??'' }}</a>
                                            ...
                                            <ul class="pl-4">
                                                ...
                                                @foreach ($childcategories as $childcategory)
                                                    <li>
                                                        <a href="{{url('/ch-product-list')}}/{{$childcategory->id}}"> {{ $childcategory->title??'' }}</a>
                                                    </li>
                                                @endforeach
