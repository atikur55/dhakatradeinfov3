                            ...
                            <div class="col-12">
                                <div class="category-sidebar-item">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{ route('allAssetsUnCat',['id' => $category->id]) }}"><i class="fas fa-angle-double-right"></i> {{ $category->category_name??'' }}</a>
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul class="pl-4">
                                                            @foreach ($child_categories as $childcategory)
                                                                <li>
                                                                    <a href="{{ url('ch-product-list') }}/{{$childcategory->id}}"> {{ $chilcategory->title??'' }}</a>
                                                                </li>
                                                            @endforeach
                                                        </ul>
                                                    </li>
                                    ...
                                    <div class="row">
                                        <div class="col-5">
                                            <div class="categories-details-img">
                                                <img class="img-fluid" src="{{ asset('uploads/subcategory') }}/{{ $subcategory->image??'photo.jpg' }}" alt="">
                                            </div>
                                        </div>
                                        <div class="col-7">
                                            <div class="categories-details">
                                                <h6><a href="{{ url('subcategory_product') }}/{{ $subcategory->id }}">{{ $subcategory->title??'' }}</a></h6>
                                                @php
                                                    $child_categories = App\Models\ChildCategory::where('subcategory_id',$subcategory->id)->where('status',0)->take(5)->get();
                                                @endphp
                                                <ul>
                                                    @forelse ($child_categories as $childcategory)
                                                        {{-- <li>{{ $product->title??'' }}</li> --}}
                                                        <a href="{{ url('ch-product-list') }}/{{ $childcategory->id }}"><li>{{ $childcategory->title??'' }}</li></a>
                                                    @empty
                                                        <li>No Data Found</li>
                                                    @endforelse
                                                </ul>
                                                <div class="categories-viewdetails">
                                                    <a href="{{ url('all-sub-assets') }}/{{ $subcategory->id }}">View Details</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
