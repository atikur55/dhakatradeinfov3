    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <h6 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Blog Add</h6>
                <!--end::Actions-->
            </div>
            <!--end::Info-->
        </div>
            ...
            <div class="row">
                <div class="col-lg-10 m-auto">
                    <div class="card card-custom">
                        ...
                        <div class="card-body">
                            <form action="{{route('supplier.blog.post')}}" method="POST" enctype="multipart/form-data" class="form">
                                @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="short_description" id="" class="form-control" cols="3" rows="2" placeholder="Enter Short Description"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="summernote" class="form-control" placeholder="Full Description"></textarea>
                                        @error('description')
                                        <div class="alert alert-danger">
                                            <strong>{{$message}}</strong>
                                        </div>
